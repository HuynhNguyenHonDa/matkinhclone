      ...
      <div className="md:flex justify-center">
        ...
        <div className="md:w-1/4 self-center">
          <p
            ...
            className="w-full p-5  text-2xl hover:cursor-pointer hover:scale-105 uppercase text-shadow animate-pulse font-bold whitespace-nowrap"
          >
            &#x1F449; Chọn Kính Phù Hợp 
          </p>
          <p className="text-center p-5 m-auto text-md ">
          ...
          {currentStep === steps.length - 1 ? (
            <>
              ...
              <div
                ...
                className="p-2 hover:cursor-pointer  invisible "
              >
                <KeyboardArrowLeftIcon />
              </div>
            </>
            ...
            <>
              ...
              <div
                onClick={handleCloseModal}
                className="border-2 p-2 text-center w-40 rounded-2xl hover:cursor-pointer text-white hover:bg-white bg-red-500 hover:text-red-400  hover:border-red-500"
              >
                Close
              </div>
              <div
